...
class Mimir:
    ...
    def _update(self):
        print('self._air_sensor.update()')
        self._air_sensor.update()

        print('self._ground_sensor.update()')
        self._ground_sensor.update()

        print('self._light_sensor.update()')
        self._light_sensor.update()

        print('self._wind_sensor.update()')
        self._wind_sensor.update()

        print('self._rain_sensor.update()')
        self._rain_sensor.update()

        print('self._wind_direction_sensor.update()')
